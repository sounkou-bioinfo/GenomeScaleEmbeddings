...
We use `duckdb` to download the embeddings from huggingFace, save them in `houba` memory-mapped matrices, and use `bigPCACpp` to perform PCA and some explorations.
