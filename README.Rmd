...
We use `duckdb` to download the embeddings from huggingFace, save them in [`houba`](github.com/HervePerdry/houba) memory-mapped matrices, and use [`bigPCACpp`](https://github.com/fbertran/bigPCAcpp/) to perform PCA and some explorations.
