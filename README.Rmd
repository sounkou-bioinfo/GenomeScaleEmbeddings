...
We explore the SNP-level LLM embeddings from the paper "**Incorporating LLM Embeddings for Variation Across the Human Genome**" ([arXiv:2509.20702v1](https://arxiv.org/html/2509.20702v1)).
We use `duckdb` to download the embeddings from huggingFace , save them in [`houba`](https://github.com/HervePerdry/houba) memory-mapped matrices, and use [`bigPCACpp`](https://github.com/fbertran/bigPCAcpp/) to perform PCA and some explorations. Please note that these embeddings look to be half of what is announced in the paper due to huggingFace limits.
...
We fetch some variants for given phenotypes using the ensembl phenotypes endpoint
...
- The embeddings explored  here were published by the workers of the paper **Incorporating LLM Embeddings for Variation Across the Human Genome** ([arXiv:2509.20702v1](https://arxiv.org/html/2509.20702v1))
